      ...
      lg:w-[95%] w-full h-fit m-auto rounded-xl flex flex-col justify-center items-start lg:px-20 px-6 py-20 gap-10`}>
        ...
        <div id='service-box' className='grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8'>
          ...
          service.map((item, index) =>(
            <div data-aos="zoom-in" data-aos-delay="200" key={"index"} className='bg-white dark:bg-black
            h-[350px] px-8 py-16 flex flex-col justify-center items-start gap-4 rounded-xl border-b-[5px]
            hover:bg-red-300 cursor-pointer'>
              ...
              dark:text-white cursor-pointer'>READ MORE</button>
            </div>
          ))
          }
        </div>
